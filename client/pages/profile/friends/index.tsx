  ...
  return (
    <MainLayout title="Friends">
      <section className="w-full flex-col items-start justify-start gap-5 h-screen overflow-y-auto overflow-x-hidden pb-20">
        ...
        <div className="tab:w-[75%] w-full tab:mx-auto flex flex-col items-start justify-start tab:flex-row py-10 gap-8 px-4 tab:px-0 bg-btngray shadow-boxShad mt-8">
          <div className="w-full flex items-center justify-between gap-5"></div>
        </div>
      </section>
    </MainLayout>
  );
